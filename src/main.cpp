          ...
          */
            ...
            if (lane == 0) {
              if (d > 4 && d < 8) {
                ...
                double check_speed = sqrt(vx*vx + vy*vy);
                double check_car_s = sensor_fusion[i][5];
                if ((check_car_s > car_s && (check_car_s - car_s > ref_vel - 0.02 * check_speed)) || car_s - check_car_s > ref_vel - 0.02 * check_speed) {
                  right = right && true;
                } else {
                  right = right && false;
                }
              ...
              if (d > 8 && d < 12) {
                ...
                if ((check_car_s > car_s && (check_car_s - car_s > ref_vel - 0.02 * check_speed)) || car_s - check_car_s > ref_vel - 0.02 * check_speed) {
                  ...
                  if (check_car_s > car_s) {
                    lane1 = std::min(lane1, check_car_s - car_s);
                  }
                } else {
                  right = right && false;
                }
              ...
              if (d > 0 && d < 4) {
                ...
                if ((check_car_s > car_s && (check_car_s - car_s > ref_vel - 0.02 * check_speed)) || car_s - check_car_s > ref_vel - 0.02 * check_speed) {
                  left = left && true;
                  if (check_car_s > car_s) {
                    lane2 = std::min(lane2, check_car_s - car_s);
                  }
                } else {
                  left = left && false;
                }
            ...
            // if (d < (2 + 4 * lane - 2) && (lane > 0) && too_close && d > (2 + 4 * (lane - 1) - 2)) { // Check left lane
            //   std::cout << "Checking left lane" << std::endl;
            //   double vx = sensor_fusion[i][3];
            //   double vy = sensor_fusion[i][4];
            //   double check_speed = sqrt(vx*vx + vy*vy);
            //   double check_car_s = sensor_fusion[i][5];
            ...
            //   if (((check_car_s - car_s) > 30) || ((car_s - check_car_s) > 20)) {
            //     left = true;
            //   } else {
            //     left = left && false;
            //   }
            // }
            // if (d > (2 + 4 * lane + 2) && (lane < 2) && too_close && d < (2 + 4 * (lane + 1) + 2)) { // Check right lane
            //   std::cout << "Checking left lane" << std::endl;
            //   double vx = sensor_fusion[i][3];
            //   double vy = sensor_fusion[i][4];
            //   double check_speed = sqrt(vx*vx + vy*vy);
